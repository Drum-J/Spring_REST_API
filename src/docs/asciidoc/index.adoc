...
operation::query-events[snippets='response-fields,curl-request,http-request,http-response,response-headers,response-fields,links']
...
operation::get-event[snippets='path-parameters,curl-request,http-request,http-response,response-headers,response-fields,links']
